...
import { FaAppleAlt, FaEdit, FaHeart, FaSun, FaSyncAlt, FaTimes } from 'react-icons/fa';
    ...
    <div className="food-recognition-overlay">
      <div className="food-recognition-modal">
        <div className="modal-header">
          <h2>{t('food.title')}</h2>
          <button className="close-btn" onClick={onClose}><FaTimes aria-hidden="true" /></button>
        </div>
            ...
            <>
              ...
              {isCameraActive && (
                <div className="camera-section" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', margin: '20px 0' }}>
                  ...
                  <div className="camera-controls" style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                    <button className="capture-btn" onClick={capturePhoto} style={{ padding: '12px 24px', borderRadius: '24px', background: '#1976D2', color: 'white', border: 'none', fontWeight: 600, fontSize: '15px', cursor: 'pointer', boxShadow: '0 4px 12px rgba(25, 118, 210, 0.25)' }}>
                      {t('food.capture')}
                    </button>
                    <button className="flip-btn" onClick={flipCamera} style={{ padding: '12px', borderRadius: '50%', background: '#E3F2FD', color: '#1976D2', border: '1px solid #bbdefb', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '46px', height: '46px' }} aria-label="Flip Camera">
                      <FaSyncAlt />
                    </button>
                    <button className="cancel-btn" onClick={stopCamera} style={{ padding: '12px 24px', borderRadius: '24px', background: '#E3F2FD', color: '#1976D2', border: '1px solid #bbdefb', fontWeight: 600, fontSize: '15px', cursor: 'pointer' }}>
                      {t('food.cancel')}
                    </button>
                  </div>
                </div>
              ...
              {imagePreview && (
                <div className="preview-section">
                  ...
                  {isProcessing && (
                    <div className="processing-overlay" style={{ color: '#1976D2' }}>
                      <div className="spinner"></div>
                  ...
                  {!isProcessing && predictions.length > 0 && nutritionData && (
                    <div className="results-container" style={{ color: '#1976D2' }}>
                        ...
                        {!isEditingPrediction ? (
                          <>
                            ...
                            <button 
                              ...
                              style={{ marginLeft: '10px', fontSize: '14px', padding: '4px 8px', borderRadius: '4px', background: '#E3F2FD', border: '1px solid #bbdefb', cursor: 'pointer', color: '#1976D2' }}
                            >
                              <FaEdit /> Not this?
                            </button>
                          </>
                          ...
                          <div className="correction-container" style={{ width: '100%', marginBottom: '10px' }}>
                            ...
                            <select 
                              ...
                              style={{ width: '100%', padding: '8px', borderRadius: '4px', border: '1px solid #bbdefb', fontSize: '16px', color: '#1976D2' }}
                            >
                      ...
                      <div className="calories-display">
                        <div className="calories-icon"><FaSun /></div>
                      ...
                      <div className="nutrition-facts">
                        <div className="nutrition-header">
                          <span className="nutrition-icon"><FaAppleAlt /></span>
