...
export const Activity: React.FC<ActivityProps> = ({ onNavigate }) => {
  ...
  const activityTypes = [
    ...
    { type: 'running', icon: '🏃', caloriesPerMin: 10, name: t('activity.running') },
    { type: 'cycling', icon: '🚴', caloriesPerMin: 8, name: t('activity.cycling') },
    { type: 'strength', icon: '💪', caloriesPerMin: 6, name: t('activity.strength') },
    { type: 'yoga', icon: '🧘', caloriesPerMin: 3, name: t('activity.yoga') },
    { type: 'swimming', icon: '🏊', caloriesPerMin: 11, name: t('activity.swimming') },
  ];
  ...
  const getActivityIcon = (type: string) => {
    return activityTypes.find(a => a.type === type)?.icon || '🏃';
  };
