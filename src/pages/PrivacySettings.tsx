        ...
        if ('Notification' in window && Notification.permission === 'granted') {
          if ('serviceWorker' in navigator) {
            navigator.serviceWorker.ready.then((registration) => {
              registration.showNotification('Privacy Updated', {
            ...
            new Notification('Privacy Updated', {
              body: 'You are now sharing your longevity score with your team. You can disable this anytime in settings.',
              icon: '/pwa-192x192.png',
            });
          }
  ...
  return (
    <div className="profile-container pb-24 premium-gradient" style={{ minHeight: '100vh' }}>
      ...
      <div className="profile-content page-content p-4 space-y-6">
        ...
        {/* Danger Zone */}
        <div className="p-6 rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50/50" style={{ padding: '1.5rem' }}>
          <h3 className="text-sm font-bold text-blue-700 mb-2">Danger Zone</h3>
          ...
          <button 
            className="w-full py-3 rounded-xl bg-blue-700 text-white text-sm font-bold shadow-lg shadow-blue-200 active:scale-95 transition-transform mt-6"
      ...
      {showConfirmModal && (
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#1976D2', marginBottom: '8px' }}>
              Share with Team?
            </h3>
            <p style={{ fontSize: '14px', color: '#1976D2', lineHeight: 1.6, marginBottom: '24px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button
                ...
                style={{
                  ...
                  fontSize: '14px', fontWeight: 600, cursor: 'pointer', color: '#1976D2',
                }}
              >
                Cancel
              </button>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button
                ...
                style={{
                  flex: 1, padding: '12px', borderRadius: '12px',
                  border: 'none', background: deleteStep === 1 ? '#1E88E5' : '#1976D2',
                  color: 'white', fontSize: '14px', fontWeight: 700, cursor: 'pointer',
                  boxShadow: '0 4px 12px rgba(25,118,210,0.3)',
