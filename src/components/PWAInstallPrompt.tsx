      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            margin: '0 auto 18px',
            background: 'linear-gradient(135deg, #E3F2FD, #d8ebfd)',
            borderRadius: '20px',
          ...
          {/* ── Header ── */}
          <h2 style={{ margin: '0 0 6px', fontSize: '20px', fontWeight: 900, color: '#1976D2', letterSpacing: '-0.4px' }}>
            Add to Home Screen
          </h2>
          <p style={{ margin: '0 0 22px', fontSize: '13.5px', color: '#1976D2', lineHeight: 1.55, fontWeight: 500 }}>
            Install <strong style={{ color: '#1976D2' }}>MFU Longevity Passport</strong> for offline access and push notifications.
          </p>

          {/* ── Platform Instructions ── */}
          {deviceType === 'ios' && (
            <div style={{
              background: 'rgba(227,242,253,0.8)', border: '1px solid rgba(25,118,210,0.15)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  ...
                  <div key={step.n} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{ fontSize: '13px', color: '#1976D2', lineHeight: 1.4 }}>{step.text}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* ── Bottom hint ── */}
          <p style={{ margin: '12px 0 0', fontSize: '11px', color: '#1976D2', fontWeight: 500 }}>
