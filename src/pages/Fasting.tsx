...
import { FaBalanceScale, FaEdit, FaFire, FaLeaf, FaPause, FaStopwatch, FaTimes } from 'react-icons/fa';
    ...
    <div className="fasting-container">
      ...
      {toastMessage && (
        <div className="fasting-toast">
          ...
          <button className="toast-close" onClick={() => setToastMessage(null)}><FaTimes aria-hidden="true" /></button>
        </div>
      )}
      ...
      <header className="fasting-header">
        ...
        <button className="timer-btn"><FaStopwatch /></button>
      </header>
      ...
      <div className="fasting-content page-content">
        <div className="timer-circle-wrapper">
          ...
          <div className="timer-inner">
            ...
            <button className="custom-btn" onClick={() => setShowCustomModal(true)} disabled={isRunning}><FaEdit /> Custom</button>
          </div>
        </div>
        ...
        <div className="glass-card p-6 rounded-3xl mt-6" style={{ padding: '1.5rem', height: 'auto', minHeight: 'fit-content' }}>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-4 items-start">
              <span className="text-xl"><FaBalanceScale /></span>
