...
export const seedDatabase = async () => {
  ...
  const mockUsers = [
    ...
    { name: 'Somchai Rakdee', email: 'somchai@mfu.ac.th', mfu_id: '643010002', role: 'staff', total_points: 7200, avatar_url: '👨‍⚕️' },
    { name: 'Admin User', email: 'admin@mfu.ac.th', mfu_id: 'admin01', role: 'admin', total_points: 9500, avatar_url: '⚙️' },
  ];
